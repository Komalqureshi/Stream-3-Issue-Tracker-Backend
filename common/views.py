...
def landingpage(request):
    data = {
        "bugs":Ticket.objects.filter(_type = "BUG").count(),
        "features":Ticket.objects.filter(_type = "FEATURE").count(),
        "users":User.objects.all().count(),
        "bugupvotes":Vote.objects.filter(issue___type = "BUG").count(),
        "featurevotes":Vote.objects.filter(issue___type = "FEATURE").count(),
        "open":Ticket.objects.filter(status = "OPEN").count(),
        "reopen":Ticket.objects.filter(status = "REOPEN").count(),
